...
#target module########
load("./R_DATA/Target_geneset.Rdata")

#phi
load("./R_DATA/tissue_phiphi.Rdata")
load("./R_DATA/tissue_phi.Rdata")
load( "./R_DATA/cell_phi.Rdata")
load("./R_DATA/pp_phi.Rdata")
load("./R_DATA/go_phi.Rdata")
load("./R_DATA/kegg_phi.Rdata")


load("./R_DATA/target_phi_12328.Rdata")#最新随机矩阵3/31
